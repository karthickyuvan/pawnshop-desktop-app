...
//       formattedString = `${utcString}T00:00:00Z`;
//     }
//     // If SQLite format (YYYY-MM-DD HH:MM:SS)
//     else if (utcString.includes(" ") && !utcString.includes("T")) {
//       formattedString = utcString.replace(" ", "T") + "Z";
//     }
//     // If already ISO without Z
//     else if (!utcString.endsWith("Z")) {
//       formattedString = utcString + "Z";
//     }
...
//     // If the string comes from SQLite as "2026-02-26 10:18:00"
//     // We must append "Z" to tell JS it is UTC before converting to IST
