...
//         <StatCard icon="🧾" label={t("total_expense")} value={`₹${(data.business_expenses || 0).toLocaleString("en-IN")}`} color="card-rose" />
...
//           <Row label={t("total_operating_expenses_lbl", "Total Expenses")} value={data.business_expenses} />
...
//               <th>{t("closed_net_hdr", "Closed Net")}</th>
//               <th>{t("closed_gross_hdr", "Closed Gross")}</th>
//             </tr>
//           </thead>
//           <tbody>
