...
//           </button>
//           <h2 style={{ marginTop: "12px", color: "#1e293b", fontWeight: "700" }}>Investor Capital Report</h2>
//           <p style={{ color: "#64748b", margin: 0 }}>Overview of deposited capital, withdrawals, and active principal balances</p>
//         </div>
...
//           <span style={{ fontSize: "0.85rem", color: "#64748b", textTransform: "uppercase" }}>Total Investment</span>
//           <strong style={{ display: "block", fontSize: "1.4rem", color: "#1e293b", marginTop: "4px" }}>₹{totalInvestment.toLocaleString("en-IN")}</strong>
//         </div>
//         <div style={{ padding: "16px", background: "#f8fafc", border: "1px solid #cbd5e1", borderRadius: "10px" }}>
//           <span style={{ fontSize: "0.85rem", color: "#64748b", textTransform: "uppercase" }}>Total Withdrawn</span>
...
//           <span style={{ fontSize: "0.85rem", color: "#166534", textTransform: "uppercase" }}>Active Capital Balance</span>
//           <strong style={{ display: "block", fontSize: "1.4rem", color: "#15803d", marginTop: "4px" }}>₹{totalCapital.toLocaleString("en-IN")}</strong>
//         </div>
//         <div style={{ padding: "16px", background: "#f8fafc", border: "1px solid #cbd5e1", borderRadius: "10px" }}>
//           <span style={{ fontSize: "0.85rem", color: "#64748b", textTransform: "uppercase" }}>Total Interest Paid</span>
...
//                 <th style={{ padding: "12px 16px" }}>Investor Name</th>
//                 <th style={{ padding: "12px 16px" }}>Fixed Rate</th>
//                 <th style={{ padding: "12px 16px" }}>Total Investment</th>
//                 <th style={{ padding: "12px 16px" }}>Total Withdrawn</th>
//                 <th style={{ padding: "12px 16px" }}>Principal Capital</th>
...
//                   <td style={{ padding: "12px 16px" }}>{r.is_active ? "Active" : "Inactive"}</td>
//                 </tr>
//               ))}
//             </tbody>
//           </table>
