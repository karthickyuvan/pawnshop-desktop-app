...
//           </button>
//           <h2 style={{ marginTop: "12px", color: "#1e293b", fontWeight: "700" }}>Investor Interest Due Report</h2>
//           <p style={{ color: "#64748b", margin: 0 }}>Identifies active investors with pending interest due, showing calculated dues</p>
//         </div>
...
//         <span style={{ fontSize: "0.85rem", color: "#b45309", textTransform: "uppercase", fontWeight: "600" }}>Total Pending Interest</span>
...
//                 <th style={{ padding: "12px 16px" }}>Months Pending</th>
//                 <th style={{ padding: "12px 16px", textAlign: "right" }}>Accrued Interest Due</th>
//               </tr>
//             </thead>
//             <tbody>
//               {rows.map((r) => (
...
//                   <td style={{ padding: "12px 16px", color: "#d97706", fontWeight: "600" }}>{r.total_months} {r.total_months === 1 ? "Month" : "Months"}</td>
//                   <td style={{ padding: "12px 16px", textAlign: "right", color: "#dc2626", fontWeight: "700" }}>₹{r.accrued_interest.toLocaleString("en-IN")}</td>
//                 </tr>
//               ))}
//             </tbody>
//           </table>
