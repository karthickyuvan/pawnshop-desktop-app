...
//     try {
//       // Helper function to safely transform any UI date format to ISO 'YYYY-MM-DD'
...
//       // FIX: Keep keys as startDate and endDate so your current Rust backend compiles perfectly
...
//         <div>
//           <h2>Interest Income Analytics</h2>
//           <p>Comprehensive monthly interest tracking (Counter Payments + Auction Recoveries)</p>
//         </div>
//         <div className="filters">
//           <input type="date" value={startDate} onChange={e => setStartDate(e.target.value)} />
//           <input type="date" value={endDate}   onChange={e => setEndDate(e.target.value)} />
//           <button onClick={loadReport} className="corporate-btn">Load Analysis</button>
//         </div>
//       </div>

//       {/* ── Corporate Analytics Cards ── */}
//       <div className="stats-grid">
//         <StatCard icon="💰" label="Total Interest Revenue" value={`₹${totalInterest.toLocaleString("en-IN", { minimumFractionDigits: 2 })}`} color="card-teal" />
//         <StatCard icon="🏆" label="Highest Yield Month" value={bestMonth.period} sub={`₹${bestMonth.interest_amount.toLocaleString("en-IN")}`} color="card-yellow" />
//         <StatCard icon="📊" label="Average Monthly Return" value={`₹${Math.floor(avg).toLocaleString("en-IN")}`} color="card-blue" />
//         <StatCard icon="📋" label="Active Months Tracked" value={rows.length} color="card-purple" />
//       </div>
...
//           <thead>
//             <tr>
//               <th>Accounting Month Period</th>
//               <th className="text-right">Interest Collected Realized</th>
//             </tr>
//           </thead>
//           <tbody>
//             {rows.map((row, index) => (
...
//                   No historical interest revenues logged in this active date range.
//                 </td>
//               </tr>
//             )}
//           </tbody>
