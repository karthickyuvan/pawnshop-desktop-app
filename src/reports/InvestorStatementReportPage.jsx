...
//           </button>
//           <h2 style={{ marginTop: "12px", color: "#1e293b", fontWeight: "700" }}>Investor Statement Report</h2>
//           <p style={{ color: "#64748b", margin: 0 }}>Detailed transactional ledger statement for chosen investors</p>
//         </div>
//         {ledger && (
...
//         <label style={{ display: "block", fontSize: "0.85rem", color: "#64748b", fontWeight: "600", marginBottom: "6px" }}>Select Investor</label>
...
//               <p style={{ margin: "4px 0 0", color: "#64748b" }}>Code: {ledger.summary.investor_code} | Type: {ledger.summary.investor_type}</p>
//             </div>
//             <div style={{ textAlign: "right" }}>
//               <span style={{ fontSize: "0.85rem", color: "#64748b" }}>Current active capital</span>
...
//                 <th style={{ padding: "12px" }}>Audit Remarks / Period</th>
//               </tr>
//             </thead>
//             <tbody>
...
//                       {tx.transaction_type === "PROFIT_PAYMENT" ? "INTEREST PAYMENT" : tx.transaction_type}
//                     </span>
//                   </td>
