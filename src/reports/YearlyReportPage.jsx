...
export default function YearlyReportPage() {
  ...
  return (
    <div className="yearly-page animate-fade-in">
      ...
      {!loading && (
        <>
          {/* ── Stat Cards Grid (Unified detailed format matching monthly report) ── */}
          <div className="stats-grid">
            ...
            <StatCard icon="📈" label={t("total_annual_revenue_lbl", "Total Annual Revenue")} value={formatCurrency(activeYearData.total_inflow)} color="card-green" />
            <StatCard icon="📉" label={t("total_annual_outflow_lbl", "Total Annual Outflow")} value={formatCurrency(activeYearData.total_outflow)} color="card-rose" />
            <StatCard icon="💰" label={t("net_retained_profit_lbl", "Net Cash Flow")} value={formatCurrency(activeYearData.net_cash_flow)} color={activeYearData.net_cash_flow >= 0 ? "card-teal" : "card-orange"} />
            ...
            <table className="metal-movement-table">
              <thead>
                <tr>
                  ...
                  <th>Active Live Vault Count (IN)</th> {/* Added Count Column */}
                  ...
                  <th>Total Released/Outflow Count</th> {/* Added Count Column */}
                </tr>
              </thead>
              <tbody>
                {metals.map((m, i) => (
