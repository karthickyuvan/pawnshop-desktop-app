...
//               <div style={{ fontSize: "12px", color: "#1d4ed8", fontWeight: "500", textTransform: "uppercase" }}>
//                 {t("active_pockets_store_lbl", "Active Pockets in Store")}
//               </div>
//               <div style={{ fontSize: "14px", marginTop: "8px" }}>
//                 {metalPockets.map((m, index) => (
//                   <div key={index}>
//                     {m.metal === "Gold" ? t("gold") : m.metal === "Silver" ? t("silver") : m.metal} : {m.pockets}
//                   </div>
//                 ))}
//                 <hr style={{ margin: "8px 0" }} />
//                 <div style={{ fontSize: "24px", fontWeight: "700", color: "#1d4ed8" }}>
//                   {t("total", "Total")} : {totalActivePockets}
//                 </div>
//               </div>
//             </div>

//             <div style={{ background: "#fffbeb", border: "1px solid #fcd34d", borderRadius: "12px", padding: "20px 24px" }}>
//               <div style={{ fontSize: "12px", color: "#b45309", fontWeight: "500", textTransform: "uppercase" }}>
//                 {t("current_pocket_running_lbl", "Current Pocket Running No.")}
//               </div>
//               <div style={{ fontSize: "32px", fontWeight: "600", color: "#b45309", marginTop: "8px" }}>
...
//               <tr>
//                 <th>{t("metal")}</th>
//                 <th>{t("gross_weight_hdr", "Gross Wt (g)")}</th>
//                 <th>{t("net_weight_hdr", "Net Wt (g)")}</th>
//                 <th>{t("total_items")}</th>
//                 <th>{t("loan_amount")}</th>
//               </tr>
//             </thead>
...
//                     <td>{row.item_count} {t("pieces_unit_lbl", "pcs")}</td>
//                     <td>₹ {row.total_loan_amount.toLocaleString("en-IN")}</td>
//                   </tr>
//                 ))
//               ) : (
//                 <tr>
...
//           {rows.length > 0 && (
//             <ChartRenderer type="pie" data={rows} xKey="metal" dataKey="net_weight" />
//           )}
//         </>
//       )}
