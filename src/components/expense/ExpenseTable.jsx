...
//   setIsDeleting(true);
//   try {
//     // Just pass the raw values here, the API file handles the literal keys now
...
// // src/components/expense/ExpenseTable.jsx -> version 2 
...
//     return unique;
//   }, [expenses, isStaff]); // ✅ Added isStaff as a dependency
...
//             onChange={(e) => setDateFilterType(e.target.value)}
//           >
//             {/* ✅ HIDE: Protect extended date filters from staff selection */}
...
//           {dateFilterType === "CUSTOM" && (
//             <>
//               {/* ✅ Uses clamped event handlers for date bounds */}
//               <input
//                 type="date"
//                 value={startDate}
