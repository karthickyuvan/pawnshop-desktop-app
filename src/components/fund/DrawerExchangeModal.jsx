...
//           .map(([n, q]) => [parseInt(n), q]),
//       });
//       alert("✅ Denomination Exchange Processed Successfully!");
//       onSuccess();
//       onClose();
//     } catch (err) {
//       alert("❌ Exchange failed: " + err);
//     } finally {
//       setLoading(false);
//     }
//   };
...
//           <h2>Cash Exchange (Change Maker)</h2>
...
//             <h4 className="exchange-column-title">📥 Inward Cash Received</h4>
...
//             <h4 className="exchange-column-title">📤 Outward Cash Given</h4>
//             <div className="exchange-denom-list">
...
//             {isMatched ? (
//               <><Check size={16} /> Totals Match perfectly</>
//             ) : (
//               <><AlertCircle size={16} /> Mismatch: ₹{(totalIn - totalOut).toLocaleString("en-IN")}</>
//             )}
//           </div>
          
//           <div className="exchange-footer-actions">
//             <button onClick={onClose} className="exchange-btn-secondary" disabled={loading}>Cancel</button>
//             <button onClick={handleSubmit} className="exchange-btn-primary" disabled={!isMatched || loading}>
//               <RefreshCw size={14} /> Process Exchange
//             </button>
//           </div>
//         </div>
//       </div>
...
//           .map(([n, q]) => [parseInt(n), q]),
//       });
//       alert(`✅ ${t("investment_saved", "Denomination Exchange Processed Successfully!")}`);
//       onSuccess();
//       onClose();
//     } catch (err) {
//       alert(`❌ ${t("operation_failed", "Exchange failed:")} ` + err);
//     } finally {
//       setLoading(false);
//     }
//   };
