...
//       });
//       showToast("success", t("investment_saved"));
//       await loadInvestors();
//     } catch (err) {
//       console.error("INVESTMENT ERROR:", err);
//       showToast("error", err?.toString() || t("operation_failed"));
//     }
//   };
...
//     try {
//       await withdrawInvestment({ ...payload, created_by: user?.id || 1 });
//       setShowWithdrawModal(false);
//       showToast("success", t("withdrawal_saved"));
//       await loadInvestors();
//     } catch (err) {
//       console.error(err);
//       showToast("error", err?.toString() || t("operation_failed"));
...
//       showToast("success", t("profit_paid"));
//       await loadInvestors();
//     } catch (err) {
//       console.error(err);
//       showToast("error", err?.toString() || t("operation_failed"));
...
//           ...formData,
//         });
//         showToast("success", t("investor_updated"));
//       } else {
//         await createInvestor({
//           ...formData,
//           created_by: user?.id || 1,
//         });
//         showToast("success", t("investor_created"));
//       }
...
//       {toast && (
//         <div
//           className={`page-toast page-toast--${toast.type}`}
...
//                       {rep.total_months} {rep.total_months === 1 ? "Month" : "Months"}
//                     </span>
//                   </td>
...
//                     <button 
//                       onClick={() => {
//                         setSelectedInvestor(investors.find(i => i.id === rep.investor_id));
