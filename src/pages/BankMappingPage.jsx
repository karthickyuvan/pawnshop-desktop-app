    ...
    setConfirmModal({
      ...
      onConfirm: async () => {
        ...
        try {
          ...
          // ✅ ADD THIS: Create the payload object
          const payload = {
      ...
      <div className="mapping-card">
        ...
        <div className="search-section">
          <div className="input-group">
            <label>
              <Fingerprint size={14} /> {t("pledge_number")} <span className="req">*</span>
            </label>
      ...
      {pledgeConfirmed && mode === "map" && (
        <div className="mapping-card">
          ...
          <div className="mapping-grid">
            ...
            <div className="input-group">
              <label>
                <IndianRupee size={14} /> {t("bank_loan_amount")} <span className="req">*</span>
              </label>
              <input
            ...
            <div className="input-group">
              <label><ReceiptText size={14} /> {t("bank_charges")}</label>
              <input
            ...
            <div className="input-group">
              <label>
                <Wallet size={14} /> {t("payment_method") } <span className="req">*</span>
              </label>
              <select
                value={paymentMethod}
                onChange={(e) => {
      ...
      {pledgeConfirmed && mode === "unmap" && (
        <div className="mapping-card">
          ...
          <div className="unmap-total-box">
            <div className="unmap-total-label">🔒 {t("total_to_pay_bank")}:</div>
          ...
          <div className="input-group" style={{ marginTop: "16px" }}>
            <label><Wallet size={14} /> {t("settlement_method")}</label>
            <select
