...
// fn set_price_per_gram_internal(
//     db: &Db,
//     metal_type_id: i64,
//     price: f64,
//     actor_user_id: i64,
...
// fn get_prices_internal(
//     db: &Db,
// ) -> Result<Vec<PricePerGram>, String> {
