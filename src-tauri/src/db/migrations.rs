...
// -- UNIFIED RECEIPT SEQUENCE TABLE
...
// -- ADD RECEIPT COLUMNS
// ALTER TABLE pledges ADD COLUMN receipt_number TEXT;

// ALTER TABLE pledge_payments ADD COLUMN receipt_number TEXT;

// -- Add unique constraint after adding column
