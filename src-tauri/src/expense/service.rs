...
//         // Standardize timestamp: check if a full ISO timestamp is already provided
//         let trimmed_date = req.expense_date.trim();
...
//     // ✅ FIX: Delete associated cash denominations tied to this expense's fund transaction
//     tx.execute(
...
//     // ✅ FIX: Physically delete the fund transactions so it doesn't leave orphans messing up the ledger
//     tx.execute(
